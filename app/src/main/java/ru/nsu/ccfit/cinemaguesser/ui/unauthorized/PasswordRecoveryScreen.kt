...
class PasswordRecoveryViewModel(
    ...
    val isCodeSent: Flow<Boolean> get() = _isCodeSent
    ...
    Column(
        ...
        Row(
            ...
            Button(
                ...
                Text(text = stringResource(if (isCodeSent) R.string.resend_code else R.string.send_code))
            }
            if (secondsLeft > 0) {
                Text(
        ...
        fun onRes(res: VerifyResult) {
            when (res) {
                VerifyResult.Success -> navController.navigate(Screen.Unauthorized.Login.PasswordRecovery.NewPassword.route)
